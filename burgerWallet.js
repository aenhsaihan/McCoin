...
class BurgerWallet {
    ...
    sign(message) {
        ...
        const senderSignature = [signature.r.toString(), signature.s.toString()];

        const messageResponse = {};
        const parsedJSONMessage = JSON.parse(message);
        Object.assign(messageResponse, parsedJSONMessage);
...
// const signedTransaction = wallet.sign(messageJSON);
